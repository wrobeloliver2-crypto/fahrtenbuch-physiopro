...
const TENANT_ID = process.env.AZURE_TENANT_ID || '84c5926a-a7f0-4d30-bfe6-8d445df9a2ba';
const CLIENT_ID = process.env.AZURE_CLIENT_ID || 'f5bba1d2-0995-495f-99eb-cdc7285fc6ec';
